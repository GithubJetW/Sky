...
/**
 * 复制文件LottoMadness.java, 然后将其重命名为NewLottoMadness.java。
 * 修改程序，将quick pick和personal choice作为组合，
 * 将按钮start，stop和reset改为复选框。
 * 
 * 
*/


public class NewLottoMadness extends JFrame {
    // set up row 1
...
//    修改stop，play， reset为复选框
    ...
    public static void main(String[] arguments) {
        NewLottoMadness frame = new NewLottoMadness();
    }
